...
OCR: Tesseract for most languages; Kraken for Ancient Greek (`grc`). No CUDA: Kraken retries on CPU. Kraken missing or still failing: Tesseract. Compose sets `gpus: all` (see root README).
