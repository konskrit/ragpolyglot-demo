import { formatSimilarityPercent, mapApiDocuments } from './documents';
...
describe('mapApiDocuments', () => {
  ...
  it('skips malformed rows', () => {
    expect(
      mapApiDocuments([{ id: '1' }, { title: 'x' }, { id: '2', title: 'ok', status: 'ready' }]),
    ).toEqual([{ id: '2', title: 'ok', status: 'ready', createdAt: undefined }]);
  });
});
